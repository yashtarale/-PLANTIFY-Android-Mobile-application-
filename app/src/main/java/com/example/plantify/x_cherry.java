...
import com.example.plantify.ml.CherryTflite;
...
public class x_cherry extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xcherry);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==1){
                    ...
                    Toast.makeText(x_cherry.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_cherry.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            CherryTflite model = CherryTflite.newInstance(getApplicationContext());
            ...
            CherryTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease: Cherry Powdery mildew","Your plant is Healthy"};
