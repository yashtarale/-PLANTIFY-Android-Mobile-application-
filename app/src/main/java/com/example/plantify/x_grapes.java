...
import com.example.plantify.ml.GrapeTflite;
...
public class x_grapes extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xgrapes);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(flag==1){
                    ...
                    Toast.makeText(x_grapes.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_grapes.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            GrapeTflite model = GrapeTflite.newInstance(getApplicationContext());
            ...
            GrapeTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease : Grape Black rot", "Disease : Grape Esca (Black_Measles)","Grape Leaf blight (Isariopsis Leaf Spot)","Your plant is Healthy"};
