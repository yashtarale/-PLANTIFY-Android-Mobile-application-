...
import com.example.plantify.ml.AppleTflite;
...
public class x_apple extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_x_apple);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==1){
                    ...
                    Toast.makeText(x_apple.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_apple.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            AppleTflite model = AppleTflite.newInstance(getApplicationContext());
            ...
            AppleTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease : Apple_scab", "Disease : Black_rot", "Disease : Cedar Apple rust","Your plant is Healthy"};
