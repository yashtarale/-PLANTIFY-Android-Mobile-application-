...
import com.example.plantify.ml.StrawberryTflite;
...
public class x_strawberry extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xstrawberry);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==1){
                    ...
                    Toast.makeText(x_strawberry.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_strawberry.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            StrawberryTflite model = StrawberryTflite.newInstance(getApplicationContext());
            ...
            StrawberryTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease : Strawberry Leaf scorch","Your plant is Healthy"};
