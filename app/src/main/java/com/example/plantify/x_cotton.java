...
import com.example.plantify.ml.CottonTflite;
...
public class x_cotton extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xcotton);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==1){
                    ...
                    Toast.makeText(x_cotton.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_cotton.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            CottonTflite model = CottonTflite.newInstance(getApplicationContext());
            ...
            CottonTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease : Bacterial blight", "Disease : curl virus","Disease : Fussarium wilt","Your plant is Healthy"};
