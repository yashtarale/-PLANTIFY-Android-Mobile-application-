...
import com.example.plantify.ml.PeachTflite;
...
public class x_peach extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xpeach);
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==1){
                    ...
                    Toast.makeText(x_peach.this, "Please Detect the disease to see solutions", Toast.LENGTH_LONG).show();
                }
                else if(flag==3){
                    Toast.makeText(x_peach.this, "Your Plant is Healty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void classifyImage(Bitmap image) {
        ...
        try {
            PeachTflite model = PeachTflite.newInstance(getApplicationContext());
            ...
            PeachTflite.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Disease : Peach Bacterial spot","Your plant is Healthy"};
